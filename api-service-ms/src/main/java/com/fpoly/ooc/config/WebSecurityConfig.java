        ...
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/admin/button", "/api/admin/collar", "/api/admin/material",
                                ...
                                "/api/admin/form", "/api/admin/product/getproductfilterByCom").permitAll()
                        ...
                        .requestMatchers("/api/admin/timeline/**", "/api/client/vouchers/display-modal-using", "/api/client/**").permitAll()
