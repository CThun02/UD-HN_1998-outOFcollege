...
//    send email
    public static final String SIGN_UP_SEND_EMAIL = """
        <!DOCTYPE html>
                    	...
                    	<tr>
                    		<td>
                    			<div class="text" style="padding: 0 2.5em; text-align: center;">
                    				...
                    				<h4>Cảm ơn bạn đã tin tưởng và đồng hành cùng chúng tôi. Bạn có thể đăng nhập vào website của chúng tôi tại đây. Chúc một ngày tốt lành!!</h4>
                    				<p><a href="http://localhost:3000/authen/sign-in" class="btn btn-primary">Đăng nhập tại đây</a></p>
                    			</div>
                    		</td>
                    	</tr>
                    </table>
