    ...
    <>
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/admin/loai-san-pham" element="loaisanpham"></Route>
          <Route path="/admin/thuong-hieu" element="thuonghieu"></Route>
          ...
          {/* Giảm giá */}
          <Route path="/admin/phieu-giam-gia" element="phieugiamgia"></Route>
          <Route
