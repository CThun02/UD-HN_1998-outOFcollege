...
import style from "../../element/bill-info/ModalBillInfoe.module.css";
        ...
        <Page style={{padding: 16, paddingBottom:100, paddingTop:50}}>
          <View style={{ padding: 10}}>
            <View  style={{ textAlign:"center", width:"100%", display:"flex", alignItems:"center", justifyContent:"center" }}>
              ...
              >
                  HÓA ĐƠN {bill?.billStatus==="ReturnS"? "TRẢ HÀNG":"BÁN HÀNG"}
              </Text>
  ...
  return (
    ...
    >
      <div id="modalContent">
        {bill && (
          <div>
            <h1 style={{ textAlign: "center" }}>HOÁ ĐƠN {bill?.billStatus==="ReturnS"? "TRẢ HÀNG":"BÁN HÀNG"}</h1>
                ...
                <div>
                  <div className={style.billInformation}>
                    <div className={style.sideSellInfor}>
                          <Row>
                            <Col span={8}>Đơn vị bán hàng </Col>
                            <Col span={16} className={style.spacing}>
                            :{" "}
